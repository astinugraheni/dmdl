<div class="row">
    <div class="col-md-3">
        <div class="box box-primary">
            ...
            <p class="text-muted text-center">Internship</p>
            </div>
        </div>

        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">About Intern</h3>
            </div>
            <div class="box-body">
                <strong><i class="fa  fa-cog"></i> Region :</strong>
                <p class="text-muted"><?php echo $result[0]->region ;?></p>
                <hr />
    ...
    <div class="col-md-9">   
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Intern Data Detail</h3>
            </div>  
                <div class="box-body">                    
